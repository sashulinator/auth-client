...
import { BindingMeta, BindingSchemaItem, Catalog } from '../model/types'
...
export default function bindAssertions(
  ...
  units: Catalog<BindingSchemaItem> | undefined,
  rootId = ROOT_ID
...
function factory(assertionList: Catalog<BindingMeta>, units: Catalog<BindingSchemaItem>, unitId: string): Schema<any> {
